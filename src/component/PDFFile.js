...
const PDFFile = () => (
  <Document>
    <Page size="A4" style={styles.body}>
      ...
      <Text style={{ textAlign: "center", margin: 20, fontWeight: "bold", fontSize: 20 }}>
        Tender Enquiry Document
      </Text>
      <Text style={{ textAlign: "center", margin: 30, fontWeight: "bold", fontSize: 11.5 }}>for</Text>
      <Text style={{ textAlign: "center", margin: 20, fontWeight: "bold", fontSize: 12 }}>
        Purchase of ________________________________ (Name of the Equipment)
      </Text>
      <Text style={{ textAlign: "center", margin: -5, fontWeight: "bold", fontSize: 14 }}>
      ...
      <Text style={{ textAlign: "center", margin: 40, fontWeight: "bold", fontSize: 14 }}>
        Tender No. IIT/SRIC/Dept. Code/Project Code/PI(Short)/23-24/EQ-
      </Text>
      <Text style={{ textAlign: "center", margin: 0, fontWeight: "bold", fontSize: 14 }}>
    ...
    <Page size="A4" style={styles.body}>
      <Text style={styles.title}>Indian Institute of Technology Kharagpur</Text>
      <Text style={styles.title}>Sponsored Research and Industrial Consultancy</Text>
      <Text style={{textAlign: 'center', margin:20,  fontSize:15}}>Table of Content</Text>
...
Certificate – Bidder Not from/ from Country sharing Land border with India, Registration of Bidder with Competent Authority & not sub-contract any work to a contractor from such countries unless such contractor is registered with the Competent Authority
    ...
    <Page size="A4" style={styles.MY}>
      <Text style={styles.title}>Indian Institute of Technology Kharagpur</Text>
      <Text style={styles.title}>Sponsored Research and Industrial Consultancy</Text>
      <Text style={{textAlign: 'center', margin:5, fontWeight:"bold", fontSize:14}}>Section - I</Text>
      <Text style={{textAlign: 'left', margin:10, fontWeight:"bold", fontSize:12}}>No. IIT/SRIC/Dept. Code/Project Code/PI(Short)/23‐24/EQ‐	     <Text style={{paddingRight: 70}}></Text>    Date: ___/___/____</Text>
      <Text style={{textAlign: 'center', margin:2, fontWeight:"bold", fontSize:12}}>Invitation for Bids / Notice Inviting Tender</Text>
      <Text style={{textAlign: 'center', margin:10, fontWeight:"bold", fontSize:12}}>(E-Procurement Mode)</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>Indian Institute of Technology Kharagpur is set up by the Act of parliament called The Institutes of Technology Act 1961 and it is declared as Institutions of National Importance and Institutions of Eminence. Sponsored Research and Industrial Consultancy (SRIC) is a Research and Industrial Consultancy unit of Indian Institute of Technology Kharagpur. On behalf of Sponsored Research and Industrial Consultancy, INDIAN INSTITUTE OF TECHNOLOGY KHARAGPUR (IIT KGP) e-tender are invited from all domestic manufacturer having registered office in India, who fulfil the criteria mentioned in the tender documents for Supply of (Name of the Equipment). The list of equipment and their specifications are given in Section V.

      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>Complete Tender Documents can be downloaded from the website  “https://eprocure.gov.in/eprocure/app” from 00 May, 2023 to 00 June, 2023 upto 12:00 HRS.  IIT KGP -SRIC shall open the Technical Bids Electronically on the specified date and time at IIT KHARAGPUR (SRIC).
      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>Interested eligible all domestic manufacturer having registered office in India may submit their bids online at  https://eprocure.gov.in/eprocure/app in Two-Bids system (i.e. Technical Bid and Price Bid) in prescribed proforma. All the documents in support of eligibility criteria etc. are also to be scanned and uploaded along with the Tender Documents. Tenders sent by any other mode will not be accepted. No tender documents will be accepted after the expiry of stipulated date and time for the purpose under any circumstances what so ever.
      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>The Earnest Money (EMD) of Rs. ……………… (Rupees) (2% of Estimated cost) shall be deposited in the form of D.D*/Pay Order*/Insurance Surety bonds/Fixed Deposit Receipt*/Bank Guarantee /Banker’s Cheque from any of the commercial bank or payment online (RTGS/NEFT) in an acceptable form. 
      </Text>
      <Text style={{textAlign:"left", margin:5, fontSize:12}}>Bid securities of the unsuccessful bidders should be returned to them at the earliest after expiry of the final bid validity and latest on or before the 30th day after the award of the contract</Text>
      <Text style={{ textAlign: 'left', paddingLeft:0, marginLeft: 0, margin: 5, fontSize: 12 }}>The Competent Authority at IITKGP-SRIC reserves the right to cancel the tender at any time or amend/withdraw any of the terms and conditions contained in the Tender Document, without assigning any reason, thereof.
      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>IITKGP-SRIC reserves the right to accept either in full or in part any tender and to reject any or all offers without assigning any reason thereof.
      </Text>
   ...
   <Page size="A4" style={styles.MY}>
      <Text style={styles.title}>Indian Institute of Technology Kharagpur</Text>
      <Text style={styles.title}>Sponsored Research and Industrial Consultancy</Text>
      <Text style={{textAlign: 'center', margin:5, fontWeight:"bold", fontSize:13}}>Section - II</Text>
      <Text style={{textAlign: 'center', margin:10,marginTop:5,  fontSize:13}}> INSTRUCTIONS TO BIDDERS</Text>
    
      <Text style={{textAlign: 'left', margin:5,  fontWeight:"bold",fontSize:12}}>A. INTRODUCTION
      </Text>
      <Text style={{textAlign: 'left', margin:5, fontSize:12}}>DEFINITIONS
      </Text>
      
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>“The Purchaser” means the DEAN (R&D), (IIT KGP-SRIC) INDIAN INSTITUTE OF TECHNOLOGY KHARAGPUR, KHARAGPUR, SRIC

      </Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>“The Bidder” means the individual or firm who participates in the tender and submits bid
      </Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>“The Agency” means the individual or firm rendering the services under the contract.
      </Text>
          <Text style={{textAlign:"left", margin:3, fontSize:11.5}}>“The Services” means all activities related to conduct & performance of contractual obligations under the contract.</Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>“The Advance Purchase Order/ Letter of intent” means the intention of IIT KGP – SRIC to place the Purchase Order on the bidder.
      </Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>“The Purchase Order” means the order placed by IIT KGP-SRIC on the Supplier/ Agency signed by IIT KGP-SRIC including all attachments and appendices thereto and all documents incorporated by reference therein. The purchase order shall be deemed as “Contract” appearing in the document.
      </Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>“The Contract Price” means the price payable to the Supplier/ Agency under the purchase order for the full and satisfactory performance of its contractual obligations.
      </Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>“Acceptance “is a process of accepting satisfactory services rendered by “Supplier/ Agency” by IIT KGP- SRIC.
      </Text>

      <Text style={{textAlign: 'left', margin:3,  fontWeight:"bold",fontSize:12}}>1. ELIGIBILITY CRITERIA
      </Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>The invitation of bids is open to all domestic manufacturer having registered office in India who fulfil the criteria as specified below.
      </Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>(I)	The Bidder shall only be either “Class-I Local Supplier” or “Class-II Local Supplier” as defined under the order no. P- 45021/2/2017-PP (B.E.-II) dated. 16/09/2020 of Ministry of Commerce and Industry, Department for Promotion of Industry and Internal Trade (Public Procurement Section). (A self-certificate shall be submitted by the bidder along with the bid about their category (i.e., Class-I or Class-II) in a prescribed format vide Section XI.
      </Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>(II)	The Bidder shall be registered legal entity under relevant act. and a copy of each of registrations shall be attached with the bids.
      </Text>
          <Text style={{textAlign:"left", margin:3,fontSize:11.5}}>(III)	Minimum Five (5) years’ experience in the field of supply of laboratory equipment.</Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>(IV)	Average Annual Turnover of at least 0,00,000 INR (Min 50% of estimated value) during last 3 financial years i.e. 2020-21, 2021-22 and 2022-23 is required. (Copy of Audited Annual Accounts of the organization for the financial year 2020-21, 2021-22 and 2022-23 shall be uploaded with the bid as proof in this regard).
      </Text>
      <Text style={{textAlign: 'left', margin:3,  fontSize:11.5}}>(V)	Copy of acknowledgement of filing of Income Tax Return for the financial year 2019-20, 2020-21 and 2021-22 shall be uploaded with the bid.
      </Text>
      <Text style={styles.pageNumber} render={({ pageNumber, totalPages }) => `${pageNumber} / ${totalPages}`} fixed />
      <Text style={styles.signature}>Signature of the Tenderer/ Date with Seal</Text>
   </Page>
   ...
   <Page size="A4" style={styles.MY}>
      <Text style={styles.title}>Indian Institute of Technology Kharagpur</Text>
      <Text style={styles.title}>Sponsored Research and Industrial Consultancy</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>(VI)	Must have supplied similar equipment to laboratories of State or Central Government Institutions or reputed Educational or Research Institution and proof of such supplies should be produced</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>(VII)	It should have PAN, TIN number and GST Registrations (proof in this regard shall be uploaded with the bid)</Text>
      <Text style={{textAlign:"left", margin:5, fontSize:12}}>(VIII)	It should not have been blacklisted by the Government Organizations, GOI, Autonomous bodies. Undertaking in Section X in this regards has to be uploaded.</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>(IX)	Registration Certificate/Certificate of incorporation, if any, including the certificate of MSME/NSIC/Other EMD Exemption Document etc.</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>(X)	Authorized dealer Certificate from Manufacturer if the agency is a dealer.</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>(XI)	Bidders should not be associated, or have been associated in the past, directly or indirectly, with a firm or any of its affiliates which have been engaged by the Purchaser to provide consulting services for the preparation of the design, specifications, and other documents to be used for the procurement of the goods to be purchased under this Invitation of Bids. </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>(XII)	Relaxation of prior turnover and experience for Start-ups (Ministry of Finance, Department of Expenditure, Public Procurement Division OM No F.20\212014-PPD dated 25.07.2016 and subsequent clarifications dt 20.09.2016; 27.07.2019; 29.06.2020</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>(XIV)	Solvency Certificate: The applicant should furnish solvency certificate issued by the applicant’s bankers.</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>(XIII)	Eligibility Restrictions based on Reciprocity : If so stipulated in the Tender Document, entities from such countries identified as not allowing Indian companies to participate in their Government procurement shall not be allowed to participate on a reciprocal basis in this tender. The term 'entity' of a country shall have the same meaning as under the FDI Policy of DPIIT as amended from time to time.</Text>
      <Text style={{textAlign: 'left', margin:5,  fontWeight:"bold",fontSize:12}}>2. COST OF BIDDING
      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>3.1	The services required to be rendered, bidding procedures and contract terms and conditions are prescribed in the Bid Documents. The Bid documents include:
      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>a)	Notice Inviting Tender & List of Equipment - Section - I
      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>b)	Time Schedule of Tender - Section IA 
      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>c)	Instructions to Bidders and General terms and Conditions - Section II
      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>d)	General (Commercial) Conditions of Contract - Section III
      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>e)	Special Conditions of the Contract - Section IV
      </Text>
      <Text style={styles.pageNumber} render={({ pageNumber, totalPages }) => `${pageNumber} / ${totalPages}`} fixed />
      <Text style={styles.signature}>Signature of the Tenderer/ Date with Seal</Text>
   </Page>
   ...
   <Page size="A4" style={styles.MY}>
      <Text style={styles.title}>Indian Institute of Technology Kharagpur</Text>
      <Text style={styles.title}>Sponsored Research and Industrial Consultancy</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>f)	Schedule of Requirements with Techno-Commercial Terms - Section V</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>g)	Proforma for Technical Bid - Section VI</Text>
      <Text style={{textAlign:"left", margin:5, fontSize:12}}>h)	Price Bid Declaration - Section VII</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>i)	Performance Security Guarantee Bond - Section VIII</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>j)	Bid Security/EMD Details Proforma - Section IX </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>k)	Undertaking - Section X</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>l)	Self-certificate for Local Content (Preference to make in India for price preference) – Section XI</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>m)	OEM Authorization – Section XII</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>n)	(For Goods/ Services Contracts) Certificate - Bidder Not from/ from Country sharing Land border with India & Registration of Bidder with Competent Authority – Section XIII</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>o)	(For Works Contracts, including Turnkey Contracts) Certificate – Bidder Not from/ from Country sharing Land border with India, Registration of Bidder with Competent Authority & not sub-contract any work to a contractor from such countries unless such contractor is registered with the Competent Authority – Section XIV</Text>
      <Text style={{textAlign:"left" , margin:5,  fontSize:12}}>p)	Checklist for the Tenderer – Section XV</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>3.2	The Bidder is expected to examine all instructions, forms, terms and specifications in the Bid Documents. Failure to furnish all information required as per the Bid Documents or submission of the bids not substantially responsive to the Bid Documents in every respect will be at the bidder’s risk and shall result in rejection of the bid.</Text>
      <Text style={{textAlign: 'left', margin:5, fontWeight:"bold", fontSize:12}}>B.	PREPARATION OF BIDS</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>Bidder should take into account any corrigendum published on the tender document before submitting their bids.</Text>
      <Text style={{textAlign: 'left', margin:5, fontWeight:"bold",  fontSize:12}}>4.	DOCUMENTS COMPRISING THE BID</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>4.1   Documentary evidence established in accordance with the eligibility criteria explained above that the bidder is eligible to bid and is qualified to perform the contract if the bid is accepted.</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>4.2   Bid Security Self Declaration Form at a prescribed format shall be furnished.</Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>4.3   A bid form and price schedule completed in accordance with the guideline.
      </Text>
      <Text style={{textAlign: 'left', margin:5,  fontSize:12}}>4.4 Bidder shall furnish a clause-by-clause compliance to the requirements and commercial conditions demonstrating responsiveness to terms and conditions. In case of deviations, a statement of deviations and exceptions of provisions of the contract and commercial 
      </Text>
      <Text style={styles.pageNumber} render={({ pageNumber, totalPages }) => `${pageNumber} / ${totalPages}`} fixed />
      <Text style={styles.signature}>Signature of the Tenderer/ Date with Seal</Text>
   </Page>
...
const PDFLayoout = () => (
  <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
    <div style={{ alignSelf: 'flex-start' }}>
      <PDFDownloadLink document={<PDFFile />} fileName="Tender_form.pdf">
